...
class SearcharrBot:
    ...
    def __init__(self, token, dev_mode=False, verbose=False):
        ...
        self.anime = self._init_service("anime", verbose)
    ...
    def _init_service(self, service_name, verbose):
        ...
        try:
            ...
            elif service_name == "anime":
                from bot.services.anime_service import configure_anime
                client = Anime(settings.anime_url, settings.anime_api_key, verbose)
                return configure_anime(client)
